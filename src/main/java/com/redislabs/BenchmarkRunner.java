    ...
    public void run() {
        ...
        for (int i = 0; i < clients; i++) {
            ...
            if (rps>0){
                ...
                clientThread = new ClientThread(pool.getResource(), requestsPerClient,key, query, histogram,graphInternalTime, rateLimiter);
            } else {
                clientThread = new ClientThread(pool.getResource(), requestsPerClient,key, query, histogram,graphInternalTime);
            }
            clientThread.start();
